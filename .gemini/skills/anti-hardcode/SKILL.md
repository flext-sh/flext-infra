...
Read the [owner migration procedure](references/procedure.md). One confirmed hardcode
blocks delivery until the typed owner validates it, every consumer is rewired, and the
literal plus alternate lookup paths are removed.
