...
class FlextInfraConstantsWorkspace:
    ...
    WORKSPACE_ENV_FILES: Final[t.StrSequence] = (
        ENVRC_FILENAME,
        MISE_TOML_FILENAME,
    )
...
"""
    WORKSPACE_MISE_TOML_CONTENT: Final[str] = """# @generated by: flext_infra workspace sync
