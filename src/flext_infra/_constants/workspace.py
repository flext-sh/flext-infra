...
class FlextInfraConstantsWorkspace:
    ...
    # Why: a profile-excluded managed workflow path is pruned as an orphan only
    # when codegen actually authored the file. A repository-owned workflow that
    # merely shares the managed path (cosmos-charts helm-semver release.yml) is
    # foreign content and must survive conform untouched.
    WORKFLOW_GENERATED_MARKERS: Final[t.StrSequence] = (
        "Generated by flext_infra codegen",
        "Generated by `flext_infra codegen conform`",
        "Generated by `flext-infra codegen conform`",
    )
    "Header markers proving codegen authored a rendered GitHub workflow."
