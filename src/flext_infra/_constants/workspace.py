...
class FlextInfraConstantsWorkspace:
    ...
    WORKSPACE_ENVRC_TEMPLATE_NAME: Final[str] = "project/base/envrc.sh.j2"
    WORKSPACE_MISE_TOML_TEMPLATE_NAME: Final[str] = "project/base/.mise.toml.j2"
    WORKSPACE_ENV_GENERATED_MARKER: Final[str] = (
        "# @generated by: flext_infra workspace sync"
    )
    # Python linters/type-checkers come from the locked dependency groups into
    # the governing .venv. Native runtimes such as Go remain mise-owned.
