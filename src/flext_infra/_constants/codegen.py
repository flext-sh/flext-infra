...
class FlextInfraConstantsCodegen(
    ...
    MISE_BOOTSTRAP_FIXED_ENVIRONMENT: ClassVar[t.StrPairTuple] = (
    ...
    MISE_BOOTSTRAP_TRANSIENT_ENVIRONMENT: ClassVar[t.StrPairTuple] = (
        ("HOME", "home"),
        ("USERPROFILE", "home"),
        ("APPDATA", "appdata"),
    ...
    MISE_BOOTSTRAP_PERSISTENT_ENVIRONMENT: ClassVar[t.StrPairTuple] = (
        ("MISE_DATA_DIR", "."),
    ...
    MISE_BOOTSTRAP_EMPTY_FILES: ClassVar[t.StrTuple] = (
        "global-config.toml",
    ...
    MISE_BOOTSTRAP_PASSTHROUGH_ENVIRONMENT: ClassVar[t.StrTuple] = (
        "PATH",
        "COMSPEC",
        "PATHEXT",
        "SYSTEMROOT",
