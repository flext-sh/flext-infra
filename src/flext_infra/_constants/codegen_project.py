...
class FlextInfraConstantsCodegenProject:
    ...
    PROJECT_TEMPLATE_ENTRIES: Final[
        ...
        (
            "base/src/_models/ping.py.j2",
            "src/{package_name}/_models/ping.py",
            _BOTH,
            "render",
            False,
        ),
        ...
        (
            "base/src/_constants/base.py.j2",
            "src/{package_name}/_constants/base.py",
            _BOTH,
            "render",
            False,
        ),
        ...
        (
            "base/src/_protocols/ping.py.j2",
            "src/{package_name}/_protocols/ping.py",
            _BOTH,
            "render",
            False,
        ),
        ...
        (
            "base/src/_typings/base.py.j2",
            "src/{package_name}/_typings/base.py",
            _BOTH,
            "render",
            False,
        ),
        ...
        # NOTE (multi-agent, mro-wkii.19.1): tests consume flext-tests and the
        # project public facades directly; no parallel test c/t/p/m/u/settings.
