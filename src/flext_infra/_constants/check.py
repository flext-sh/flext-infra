...
class FlextInfraConstantsCheck:
    ...
    "are warning-only for CI — the debts stay tracked in beads while CI "
    "blocks on the correctness gates (lint, mypy, pyright, silent-failure, "
    "security, boundary, markdown)."
