...
class FlextInfraGithubService:
    ...
    def execute_workflows(self, params: m.Infra.GithubWorkflowsInput) -> r[bool]:
    ...
    def execute_lint(
        self,
        params: m.Infra.GithubLintInput,
