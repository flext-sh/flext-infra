...
class FlextInfraDepsModelsToolConfig:
    ...
    class RuffLintConfig(m.ArbitraryTypesModel):
        ...
        isort: FlextInfraDepsModelsToolConfig.RuffIsortConfig
    ...
    class RuffConfig(m.ArbitraryTypesModel):
        ...
        format: FlextInfraDepsModelsToolConfig.RuffFormatConfig
        lint: FlextInfraDepsModelsToolConfig.RuffLintConfig
    ...
    class MypyConfig(m.ArbitraryTypesModel):
        ...
        overrides: Annotated[
            Sequence[FlextInfraDepsModelsToolConfig.MypyOverrideConfig],
            Field(
