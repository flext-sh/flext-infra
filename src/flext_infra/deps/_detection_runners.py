...
class FlextInfraDependencyDetectionRunnersMixin:
        ...
        *,
        ...
        if out_file.exists():
            ...
            if loaded_result.failure:
                return r[t.Pair[t.SequenceOf[t.JsonMapping], int]].from_failure(loaded_result)
            ...
            if json_output_path is None:
                try:
                    ...
                    return r[t.Pair[t.SequenceOf[t.JsonMapping], int]].fail(f"failed to cleanup deptry temp output: {exc}", exception=exc)
    ...
    def run_pip_check(
        ...
        return r[t.Pair[t.StrSequence, int]].ok((lines, cmd_result.outcome.raw_return_code))
