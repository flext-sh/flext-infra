...
class FlextInfraNamespaceRulesBase:
    ...
    @classmethod
    def name_of(cls, node: t.JsonValue | None) -> str:
    ...
    @classmethod
    def dotted_name(cls, node: t.JsonValue | None) -> str:
    ...
    @classmethod
    def is_type_checking_guard(cls, node: t.JsonValue) -> bool:
