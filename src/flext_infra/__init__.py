...
_LAZY_IMPORTS: Mapping[str, tuple[str, str]] = {
    ...
    "FunctionDependencyCollector": ("flext_infra.refactor._function_dependency_collector", "FunctionDependencyCollector"),
    ...
    "ImportDependencyCollector": ("flext_infra.refactor._import_dependency_collector", "ImportDependencyCollector"),
    ...
    "NormalizerContext": ("flext_infra.transformers._utilities_normalizer", "NormalizerContext"),
    ...
    "TopLevelClassCollector": ("flext_infra.refactor._top_level_class_collector", "TopLevelClassCollector"),
