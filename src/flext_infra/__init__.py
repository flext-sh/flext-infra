...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    "CONTAINER_DICT_SEQ_ADAPTER": ["flext_infra.refactor._base_rule", "CONTAINER_DICT_SEQ_ADAPTER"],
    ...
    "FlextInfraBaseMkValidator": ["flext_infra.validate.basemk_validator", "FlextInfraBaseMkValidator"],
    "FlextInfraBasemkConstants": ["flext_infra.basemk._constants", "FlextInfraBasemkConstants"],
    ...
    "FlextInfraChangeTracker": ["flext_infra.refactor._base_rule", "FlextInfraChangeTracker"],
    "FlextInfraChangeTrackingTransformer": ["flext_infra.transformers._base", "FlextInfraChangeTrackingTransformer"],
    "FlextInfraCheckConstants": ["flext_infra.check._constants", "FlextInfraCheckConstants"],
    ...
    "FlextInfraClassPlacementDetector": ["flext_infra.detectors.class_placement_detector", "FlextInfraClassPlacementDetector"],
    "FlextInfraCodegenCensus": ["flext_infra.codegen.census", "FlextInfraCodegenCensus"],
    "FlextInfraCodegenCoercion": ["flext_infra.codegen._codegen_coercion", "FlextInfraCodegenCoercion"],
    "FlextInfraCodegenConstants": ["flext_infra.codegen._constants", "FlextInfraCodegenConstants"],
    "FlextInfraCodegenConstantsQualityGate": ["flext_infra.codegen.constants_quality_gate", "FlextInfraCodegenConstantsQualityGate"],
    "FlextInfraCodegenExecutionTools": ["flext_infra.codegen._codegen_execution_tools", "FlextInfraCodegenExecutionTools"],
    "FlextInfraCodegenFixer": ["flext_infra.codegen.fixer", "FlextInfraCodegenFixer"],
    "FlextInfraCodegenGeneration": ["flext_infra.codegen._codegen_generation", "FlextInfraCodegenGeneration"],
    "FlextInfraCodegenLazyInit": ["flext_infra.codegen.lazy_init", "FlextInfraCodegenLazyInit"],
    "FlextInfraCodegenMetrics": ["flext_infra.codegen._codegen_metrics", "FlextInfraCodegenMetrics"],
    "FlextInfraCodegenMetricsChecks": ["flext_infra.codegen._codegen_metrics_checks", "FlextInfraCodegenMetricsChecks"],
    "FlextInfraCodegenModels": ["flext_infra.codegen._models", "FlextInfraCodegenModels"],
    ...
    "FlextInfraCodegenSnapshot": ["flext_infra.codegen._codegen_snapshot", "FlextInfraCodegenSnapshot"],
    "FlextInfraCompatibilityAliasDetector": ["flext_infra.detectors.compatibility_alias_detector", "FlextInfraCompatibilityAliasDetector"],
    ...
    "FlextInfraCyclicImportDetector": ["flext_infra.detectors.cyclic_import_detector", "FlextInfraCyclicImportDetector"],
    "FlextInfraDependencyAnalyzer": ["flext_infra.detectors.dependency_analyzer_base", "FlextInfraDependencyAnalyzer"],
    "FlextInfraDependencyDetectionService": ["flext_infra.deps.detection", "FlextInfraDependencyDetectionService"],
    "FlextInfraDependencyDetectorRuntime": ["flext_infra.deps._detector_runtime", "FlextInfraDependencyDetectorRuntime"],
    "FlextInfraDependencyPathSync": ["flext_infra.deps.path_sync", "FlextInfraDependencyPathSync"],
    "FlextInfraDepsConstants": ["flext_infra.deps._constants", "FlextInfraDepsConstants"],
    ...
    "FlextInfraDocsConstants": ["flext_infra.docs._constants", "FlextInfraDocsConstants"],
    ...
    "FlextInfraFunctionDependencyCollector": ["flext_infra.refactor._function_dependency_collector", "FlextInfraFunctionDependencyCollector"],
    "FlextInfraFutureAnnotationsDetector": ["flext_infra.detectors.future_annotations_detector", "FlextInfraFutureAnnotationsDetector"],
    "FlextInfraGate": ["flext_infra.gates._base_gate", "FlextInfraGate"],
    "FlextInfraGateRegistry": ["flext_infra.gates._gate_registry", "FlextInfraGateRegistry"],
    "FlextInfraGatesModels": ["flext_infra.gates._models", "FlextInfraGatesModels"],
    "FlextInfraGenericTransformerRule": ["flext_infra.refactor._base_rule", "FlextInfraGenericTransformerRule"],
    "FlextInfraGithubConstants": ["flext_infra.github._constants", "FlextInfraGithubConstants"],
    ...
    "FlextInfraImportAliasDetector": ["flext_infra.detectors.import_alias_detector", "FlextInfraImportAliasDetector"],
    "FlextInfraImportCollector": ["flext_infra.detectors.import_collector", "FlextInfraImportCollector"],
    "FlextInfraImportDependencyCollector": ["flext_infra.refactor._import_dependency_collector", "FlextInfraImportDependencyCollector"],
    ...
    "FlextInfraInternalImportDetector": ["flext_infra.detectors.internal_import_detector", "FlextInfraInternalImportDetector"],
    "FlextInfraInventoryService": ["flext_infra.validate.inventory", "FlextInfraInventoryService"],
    "FlextInfraLooseObjectDetector": ["flext_infra.detectors.loose_object_detector", "FlextInfraLooseObjectDetector"],
    "FlextInfraMROCompletenessDetector": ["flext_infra.detectors.mro_completeness_detector", "FlextInfraMROCompletenessDetector"],
    "FlextInfraManualProtocolDetector": ["flext_infra.detectors.manual_protocol_detector", "FlextInfraManualProtocolDetector"],
    "FlextInfraManualTypingAliasDetector": ["flext_infra.detectors.manual_typing_alias_detector", "FlextInfraManualTypingAliasDetector"],
    ...
    "FlextInfraNamespaceEnforcerModels": ["flext_infra.refactor._models_namespace_enforcer", "FlextInfraNamespaceEnforcerModels"],
    "FlextInfraNamespaceFacadeScanner": ["flext_infra.detectors.namespace_facade_scanner", "FlextInfraNamespaceFacadeScanner"],
    "FlextInfraNamespaceSourceDetector": ["flext_infra.detectors.namespace_source_detector", "FlextInfraNamespaceSourceDetector"],
    "FlextInfraNamespaceValidator": ["flext_infra.validate.namespace_validator", "FlextInfraNamespaceValidator"],
    ...
    "FlextInfraNormalizerContext": ["flext_infra.transformers._utilities_normalizer", "FlextInfraNormalizerContext"],
    ...
    "FlextInfraProtocolsRope": ["flext_infra._protocols.rope", "FlextInfraProtocolsRope"],
    ...
    "FlextInfraPytestDiagExtractor": ["flext_infra.validate.pytest_diag", "FlextInfraPytestDiagExtractor"],
    ...
    "FlextInfraRefactorAstGrepModels": ["flext_infra.refactor._models_ast_grep", "FlextInfraRefactorAstGrepModels"],
    ...
    "FlextInfraRefactorConstants": ["flext_infra.refactor._constants", "FlextInfraRefactorConstants"],
    ...
    "FlextInfraRefactorModels": ["flext_infra.refactor._models", "FlextInfraRefactorModels"],
    "FlextInfraRefactorPatternCorrectionsRule": ["flext_infra.rules.pattern_corrections", "FlextInfraRefactorPatternCorrectionsRule"],
    "FlextInfraRefactorRule": ["flext_infra.refactor._base_rule", "FlextInfraRefactorRule"],
    ...
    "FlextInfraReleaseConstants": ["flext_infra.release._constants", "FlextInfraReleaseConstants"],
    "FlextInfraReleaseModels": ["flext_infra.release._models", "FlextInfraReleaseModels"],
    ...
    "FlextInfraRuntimeAliasDetector": ["flext_infra.detectors.runtime_alias_detector", "FlextInfraRuntimeAliasDetector"],
    "FlextInfraRuntimeDevDependencyDetector": ["flext_infra.deps.detector", "FlextInfraRuntimeDevDependencyDetector"],
    "FlextInfraScanFileMixin": ["flext_infra.detectors._base_detector", "FlextInfraScanFileMixin"],
    "FlextInfraSharedInfraConstants": ["flext_infra.validate._constants", "FlextInfraSharedInfraConstants"],
    "FlextInfraSkillValidator": ["flext_infra.validate.skill_validator", "FlextInfraSkillValidator"],
    "FlextInfraStubSupplyChain": ["flext_infra.validate.stub_chain", "FlextInfraStubSupplyChain"],
    "FlextInfraSyncService": ["flext_infra.workspace.sync", "FlextInfraSyncService"],
    "FlextInfraTextPatternScanner": ["flext_infra.validate.scanner", "FlextInfraTextPatternScanner"],
    "FlextInfraTopLevelClassCollector": ["flext_infra.refactor._top_level_class_collector", "FlextInfraTopLevelClassCollector"],
    ...
    "FlextInfraUtilitiesCodegenConstantDetection": ["flext_infra.codegen._utilities_codegen_constant_visitor", "FlextInfraUtilitiesCodegenConstantDetection"],
    "FlextInfraUtilitiesCodegenConstantTransformation": ["flext_infra.codegen._utilities_codegen_constant_transformer", "FlextInfraUtilitiesCodegenConstantTransformation"],
    "FlextInfraUtilitiesCodegenExecution": ["flext_infra.codegen._utilities_codegen_execution", "FlextInfraUtilitiesCodegenExecution"],
    "FlextInfraUtilitiesCodegenGovernance": ["flext_infra.codegen._utilities_codegen_governance", "FlextInfraUtilitiesCodegenGovernance"],
    "FlextInfraUtilitiesCodegenTransforms": ["flext_infra.codegen._utilities_transforms", "FlextInfraUtilitiesCodegenTransforms"],
    ...
    "FlextInfraUtilitiesImportNormalizer": ["flext_infra.transformers._utilities_normalizer", "FlextInfraUtilitiesImportNormalizer"],
    ...
    "FlextInfraUtilitiesRefactor": ["flext_infra.refactor._utilities", "FlextInfraUtilitiesRefactor"],
    "FlextInfraUtilitiesRefactorCli": ["flext_infra.refactor._utilities_cli", "FlextInfraUtilitiesRefactorCli"],
    "FlextInfraUtilitiesRefactorLoader": ["flext_infra.refactor._utilities_loader", "FlextInfraUtilitiesRefactorLoader"],
    "FlextInfraUtilitiesRefactorMroScan": ["flext_infra.refactor._utilities_mro_scan", "FlextInfraUtilitiesRefactorMroScan"],
    "FlextInfraUtilitiesRefactorMroTransform": ["flext_infra.refactor._utilities_mro_transform", "FlextInfraUtilitiesRefactorMroTransform"],
    "FlextInfraUtilitiesRefactorNamespace": ["flext_infra.refactor._utilities_namespace", "FlextInfraUtilitiesRefactorNamespace"],
    "FlextInfraUtilitiesRefactorPydantic": ["flext_infra.refactor._utilities_pydantic", "FlextInfraUtilitiesRefactorPydantic"],
    "FlextInfraUtilitiesRefactorPydanticAnalysis": ["flext_infra.refactor._utilities_pydantic_analysis", "FlextInfraUtilitiesRefactorPydanticAnalysis"],
    ...
    "FlextInfraUtilitiesRope": ["flext_infra._utilities.rope", "FlextInfraUtilitiesRope"],
    ...
    "FlextInfraWorkspaceConstants": ["flext_infra.workspace._constants", "FlextInfraWorkspaceConstants"],
    ...
    "FlextInfraWorkspaceModels": ["flext_infra.workspace._models", "FlextInfraWorkspaceModels"],
    "INFRA_MAPPING_ADAPTER": ["flext_infra.refactor._base_rule", "INFRA_MAPPING_ADAPTER"],
