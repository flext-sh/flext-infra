...
if TYPE_CHECKING:
    ...
    from . import (
        check, codegen, codemod, deps,
        detectors, docs, fixers, gates,
        maintenance, refactor, release, services,
        transformers, validate, workspace,
    )
    from .__main__ import FlextInfraMain
...
__all__: tuple[str, ...] = (
    "TEST_SKIP_MARKER", "CliDispatchService", "CliRouteBase", "CliRouteService",
    "CodegenRoutes", "FlextInfra", "FlextInfraAbstractionBoundaryGate", "FlextInfraAccessorMigrationOrchestrator",
    "FlextInfraBanditGate", "FlextInfraBooleanLogicFixer", "FlextInfraCProfileReport", "FlextInfraCanonicalAliasGate",
    "FlextInfraClassPlacementDetector", "FlextInfraCleanService", "FlextInfraCli", "FlextInfraCodegenCensus",
    "FlextInfraCodegenConform", "FlextInfraCodegenConsolidator", "FlextInfraCodegenFixer", "FlextInfraCodegenGeneration",
    "FlextInfraCodegenLayout", "FlextInfraCodegenLazyInit", "FlextInfraCodegenLazyInitPlanner", "FlextInfraCodegenMakeBootstrap",
    "FlextInfraCodegenMiseArtifacts", "FlextInfraCodegenPipeline", "FlextInfraCodegenProjectNew", "FlextInfraCodegenProtocolModels",
    "FlextInfraCodegenPyTyped", "FlextInfraCodegenQualityGate", "FlextInfraCodegenScaffolder", "FlextInfraCodegenTransaction",
    "FlextInfraCodegenVersionFile", "FlextInfraCodemodAstScan", "FlextInfraCodemodBatchApply", "FlextInfraCodemodSedApply",
    "FlextInfraCodemodSemanticApply", "FlextInfraCodemodSnapshotReconciler", "FlextInfraCompatibilityAliasDetector", "FlextInfraConfig",
    "FlextInfraConfigFixer", "FlextInfraConsolidateGroupsPhase", "FlextInfraConstants", "FlextInfraConsumerImportViolationsDetector",
    "FlextInfraCyclicImportDetector", "FlextInfraDeferredSelfReferenceDetector", "FlextInfraDeferredSelfReferenceGate", "FlextInfraDependencyDetectionAnalysis",
    "FlextInfraDependencyDetectionService", "FlextInfraDependencyDetectorRuntime", "FlextInfraDirenvGate", "FlextInfraDocAuditor",
    "FlextInfraDocAuditorMixin", "FlextInfraDocBuilder", "FlextInfraDocCollector", "FlextInfraDocFixer",
    "FlextInfraDocGenerator", "FlextInfraDocServer", "FlextInfraDocServiceBase", "FlextInfraDocValidator",
    "FlextInfraDuplicationGate", "FlextInfraEnforcementFixerOrchestrator", "FlextInfraEnsurePackagingPhase", "FlextInfraEnsurePyreflyConfigPhase",
    "FlextInfraEnsurePyrightConfigPhase", "FlextInfraEnsureRuffConfigPhase", "FlextInfraExtraPathsManager", "FlextInfraFixerAdapter",
    "FlextInfraFlextBindingService", "FlextInfraFutureAnnotationsDetector", "FlextInfraGate", "FlextInfraGateContractChecksMixin",
    "FlextInfraGateContractContentMixin", "FlextInfraGateContractReportMixin", "FlextInfraGateContractScanMixin", "FlextInfraGateContractValidator",
    "FlextInfraGateFixerAdapter", "FlextInfraGateRegistry", "FlextInfraGitService", "FlextInfraImportAliasDetector",
    "FlextInfraIndexDeclarationsGate", "FlextInfraInjectCommentsPhase", "FlextInfraInlineImportDetector", "FlextInfraInternalImportDetector",
    "FlextInfraInventoryService", "FlextInfraLayoutGate", "FlextInfraLocCapGate", "FlextInfraLocDeltaValidator",
    "FlextInfraLooseObjectDetector", "FlextInfraLooseTestFunctionDetector", "FlextInfraLspDiagnosticsDetector", "FlextInfraMain",
    "FlextInfraManualCommandValidator", "FlextInfraManualProtocolDetector", "FlextInfraManualTypingAliasDetector", "FlextInfraMarkdownCodeGate",
    "FlextInfraMarkdownFormatGate", "FlextInfraMarkdownGate", "FlextInfraMarkdownGateBase", "FlextInfraMiseWorkspacePlanner",
    "FlextInfraModGateEngine", "FlextInfraModReplacements", "FlextInfraModTextGateEngine", "FlextInfraModels",
    "FlextInfraModernizeOrchestrator", "FlextInfraMypyGate", "FlextInfraNamespaceEnforcer", "FlextInfraNamespaceEnforcerPhasesMixin",
    "FlextInfraNamespaceGate", "FlextInfraNamespaceRules", "FlextInfraNamespaceSourceDetector", "FlextInfraNamespaceValidator",
    "FlextInfraOrchestratorService", "FlextInfraPrivateImportBypassDetector", "FlextInfraProjectClassifier", "FlextInfraProjectSelectionServiceBase",
    "FlextInfraPromoted", "FlextInfraProtocols", "FlextInfraProtocolsBase", "FlextInfraPyprojectModernizer",
    "FlextInfraPyreflyGate", "FlextInfraPyrightGate", "FlextInfraPytestDiagExtractor", "FlextInfraPytestRunner",
    "FlextInfraPythonVersionEnforcer", "FlextInfraRefactorCensus", "FlextInfraRefactorClassReconstructor", "FlextInfraRefactorClassvarConstantAutofix",
    "FlextInfraRefactorCompatibilityAlias", "FlextInfraRefactorDataclassModelizer", "FlextInfraRefactorDeprecatedRemover", "FlextInfraRefactorFutureImport",
    "FlextInfraRefactorHardcodedVersion", "FlextInfraRefactorImportBypassRemover", "FlextInfraRefactorImportModernizer", "FlextInfraRefactorLazyImportFixer",
    "FlextInfraRefactorMroRemover", "FlextInfraRefactorOpenEncoding", "FlextInfraRefactorPatternTransformer", "FlextInfraRefactorProjectAliasMigrator",
    "FlextInfraRefactorPydanticModernizer", "FlextInfraRefactorSignaturePropagation", "FlextInfraRefactorSignaturePropagator", "FlextInfraRefactorSymbolPropagator",
    "FlextInfraRefactorTypingUnifier", "FlextInfraReleaseOrchestrator", "FlextInfraReleaseOrchestratorPhases", "FlextInfraReleasePolicyRender",
    "FlextInfraRopeWorkspace", "FlextInfraRuffFormatGate", "FlextInfraRuffLintGate", "FlextInfraRuntimeAliasDetector",
    "FlextInfraRuntimeCensusGate", "FlextInfraRuntimeCensusValidator", "FlextInfraRuntimeDevDependencyDetector", "FlextInfraScannerGateMixin",
    "FlextInfraServiceBase", "FlextInfraSettings", "FlextInfraSilentFailureDetector", "FlextInfraSilentFailureGate",
    "FlextInfraSilentFailureValidator", "FlextInfraSkillValidator", "FlextInfraSmellFixer", "FlextInfraSmellsGate",
    "FlextInfraStubSupplyChain", "FlextInfraTestmonDbInspector", "FlextInfraTextPatternScanner", "FlextInfraTierWhitelistGate",
    "FlextInfraToolTablesPhase", "FlextInfraTransformerFixerAdapter", "FlextInfraTypes", "FlextInfraUtilities",
    "FlextInfraValidateFreshImport", "FlextInfraValidateImportCycles", "FlextInfraValidateLazyMapFreshness", "FlextInfraValidateMetadataDiscipline",
    "FlextInfraValidateTierWhitelist", "FlextInfraVersion", "FlextInfraWorkspaceBeadsEnvironmentMixin", "FlextInfraWorkspaceCheckGatesMixin",
    "FlextInfraWorkspaceChecker", "FlextInfraWorkspaceDetector", "FlextInfraWorkspaceEnvironmentContracts", "FlextInfraWorkspaceEnvironmentMixin",
    "FlextInfraWorkspaceEnvironmentProvenance", "FlextInfraWorkspaceEnvironmentSync", "FlextInfraWorktreeService", "FlextInfraWrapperRootNamespaceRefactor",
    "GateContractInfraError", "GateContractUsageError", "RefactorRoutes", "ValidationCommandRoutes",
    "ValidationRoutes", "WorkspaceRoutes", "__author__", "__author_email__",
    "__description__", "__license__", "__title__", "__url__",
    "__version__", "__version_info__", "c", "check",
    "codegen", "codemod", "collect_markdown_files", "config",
    "d", "deps", "detectors", "docs",
    "docs_main", "e", "fixers", "gates",
    "h", "infra", "m", "main",
    "maintenance", "p", "r", "read_ignore_patterns",
    "refactor", "release", "s", "services",
    "settings", "source_name", "t", "transformers",
    "u", "validate", "workspace", "write_docstring_sources",
    "write_fenced_block_sources", "x",
)

_LAZY_IMPORTS = MappingProxyType(
    build_lazy_import_map(
        MappingProxyType({
            ".__main__": ("FlextInfraMain",),
            ...
            ".gates.markdown_code_sources": (
                "TEST_SKIP_MARKER", "source_name", "write_docstring_sources",
                "write_fenced_block_sources",
            ),
            ".gates.markdown_format": ("FlextInfraMarkdownFormatGate",),
            ".gates.markdown_support": (
                "FlextInfraMarkdownGateBase", "collect_markdown_files",
                "read_ignore_patterns",
            ),
            ...
            ".validate.gate_contract_errors": (
                "GateContractInfraError", "GateContractUsageError",
            ),
