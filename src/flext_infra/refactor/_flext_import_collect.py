"""FLEXT import-rewrite rope file-ops: occurrence collection + protected writes."""
...
class FlextInfraRefactorFLEXTImportRewriterFileOpsMixin:
    """Discover consumer occurrences, build the symbol-move map, persist sources.

    Composed into FlextInfraRefactorFLEXTImportRewriter via inheritance; the
    classmethods resolve their intra-cluster siblings through ``cls`` FLEXT.
    """
...
__all__: list[str] = ["FlextInfraRefactorFLEXTImportRewriterFileOpsMixin"]
