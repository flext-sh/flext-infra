"""Validation helpers for remaining FLEXT migration candidates."""
...
class FlextInfraRefactorFLEXTMigrationValidator:
    """Validator for FLEXT migration completeness and correctness."""
...
__all__: list[str] = ["FlextInfraRefactorFLEXTMigrationValidator"]
