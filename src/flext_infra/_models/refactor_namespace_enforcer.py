...
class FlextInfraNamespaceEnforcerModels:
    ...
    class ProjectEnforcementReport(
        ...
        loose_objects: Sequence[FlextInfraNamespaceEnforcerModels.LooseObjectViolation] = []
        import_violations: Sequence[FlextInfraNamespaceEnforcerModels.ImportAliasViolation] = []
        namespace_source_violations: Sequence[FlextInfraNamespaceEnforcerModels.NamespaceSourceViolation] = []
        internal_import_violations: Sequence[FlextInfraNamespaceEnforcerModels.InternalImportViolation] = []
        manual_protocol_violations: Sequence[FlextInfraNamespaceEnforcerModels.ManualProtocolViolation] = []
        cyclic_imports: Sequence[FlextInfraNamespaceEnforcerModels.CyclicImportViolation] = []
        runtime_alias_violations: Sequence[FlextInfraNamespaceEnforcerModels.RuntimeAliasViolation] = []
        future_violations: Sequence[FlextInfraNamespaceEnforcerModels.FutureAnnotationsViolation] = []
        manual_typing_violations: Sequence[FlextInfraNamespaceEnforcerModels.ManualTypingAliasViolation] = []
        compatibility_alias_violations: Sequence[FlextInfraNamespaceEnforcerModels.CompatibilityAliasViolation] = []
        class_placement_violations: Sequence[FlextInfraNamespaceEnforcerModels.ClassPlacementViolation] = []
        mro_completeness_violations: Sequence[FlextInfraNamespaceEnforcerModels.MROCompletenessViolation] = []
        parse_failures: Sequence[FlextInfraNamespaceEnforcerModels.ParseFailureViolation] = []
    ...
    class WorkspaceEnforcementReport(FlextModels.ArbitraryTypesModel):
        ...
        projects: Sequence[FlextInfraNamespaceEnforcerModels.ProjectEnforcementReport] = []
