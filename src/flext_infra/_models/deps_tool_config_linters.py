...
class RuffConfig(m.ArbitraryTypesModel):
    ...
    respect_gitignore: Annotated[
        bool,
        Field(alias="respect-gitignore", description="Respect .gitignore exclusions."),
    ]
...
class MypyConfig(m.ArbitraryTypesModel):
    ...
    plugins: Annotated[t.StrSequence, Field(description="Mypy plugins list.")] = Field(
...
class PydanticMypyConfig(m.ArbitraryTypesModel):
    ...
    init_forbid_extra: Annotated[
        bool,
        Field(description="Enable forbid-extra init behavior in pydantic mypy plugin."),
    ]
    init_typed: Annotated[
        bool,
        Field(description="Enable typed __init__ signatures in pydantic mypy plugin."),
    ]
    warn_required_dynamic_aliases: Annotated[
        bool,
        Field(description="Warn on required dynamic aliases in pydantic mypy plugin."),
    ]
