...
class FlextInfraConfigModels:
    ...
    # Environment render and workspace-sync models live on the split family
    # owners (`_config/beads.py`, `_config/render.py`); the god-module copies
    # were exterminated so the families stay the single definition source.
    EnvrcRenderSpec = FlextInfraConfigModelsRender.EnvrcRenderSpec
    BeadsConfigRenderSpec = FlextInfraConfigModelsBeads.BeadsConfigRenderSpec
    BeadsMetadataRenderSpec = FlextInfraConfigModelsBeads.BeadsMetadataRenderSpec
    WorkspaceEnvironmentCliRequest = (
        FlextInfraConfigModelsBeads.WorkspaceEnvironmentCliRequest
    )
    WorkspaceEnvironmentSyncRequest = (
        FlextInfraConfigModelsBeads.WorkspaceEnvironmentSyncRequest
    )
    BeadsWorkspaceEnvironmentSpec = (
        FlextInfraConfigModelsBeads.BeadsWorkspaceEnvironmentSpec
    )
    WorkspaceEnvironmentSyncResult = (
        FlextInfraConfigModelsBeads.WorkspaceEnvironmentSyncResult
    )
