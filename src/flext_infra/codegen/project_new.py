...
# NOTE (multi-agent, flext-wkii.14 / agent: codegen): new file per operator live
...
class FlextInfraCodegenProjectNew(s[m.Infra.CodegenResult]):
    ...
    # NOTE (multi-agent, flext-wkii.14 / agent: codegen): field renamed
    ...
    # NOTE (multi-agent, flext-wkii.4.15 / agent: codex): project config owns the
