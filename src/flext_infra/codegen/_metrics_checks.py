...
from flext_infra.codegen._metrics import FlextInfraCodegenMetrics
...
class FlextInfraCodegenMetricsChecks(FlextInfraCodegenMetrics):
    ...
    def quality_gate_compute_verdict(
        ...
        if any(
            ...
            return "FAIL"
        if (
            FlextInfraCodegenMetrics.as_int(improvement.get("violations_increased")) > 0
            or FlextInfraCodegenMetrics.as_int(improvement.get("duplicates_increased"))
            > 0
        ):
            return "FAIL"
