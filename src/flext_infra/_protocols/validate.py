...
class FlextInfraProtocolsValidate(Protocol):
    ...
    class GithubWorkflowSyncReport(p.BaseModel, Protocol):
        ...
        @property
        def operations(self) -> FlextInfraProtocolsValidate.GithubWorkflowSyncOperation: ...
    ...
    class GrpcProjectRender(p.BaseModel, Protocol):
        ...
        @property
        def artifacts(self) -> t.SequenceOf[FlextInfraProtocolsValidate.GrpcGeneratedArtifact]: ...
    ...
    class MypyConfig(p.BaseModel, Protocol):
        ...
        @property
        def overrides(self) -> t.SequenceOf[FlextInfraProtocolsValidate.MypyOverrideConfig]: ...
    ...
    class ProjectEnforcementReport(p.BaseModel, Protocol):
        ...
        @property
        def import_violations(self) -> FlextInfraProtocolsValidate.ImportAliasViolation: ...

        @property
        def namespace_source_violations(self) -> FlextInfraProtocolsValidate.NamespaceSourceViolation: ...

        @property
        def internal_import_violations(self) -> FlextInfraProtocolsValidate.InternalImportViolation: ...

        @property
        def private_import_bypass_violations(self) -> FlextInfraProtocolsValidate.PrivateImportBypassViolation: ...

        @property
        def manual_protocol_violations(self) -> FlextInfraProtocolsValidate.ManualProtocolViolation: ...

        @property
        def cyclic_imports(self) -> FlextInfraProtocolsValidate.CyclicImportViolation: ...

        @property
        def runtime_alias_violations(self) -> FlextInfraProtocolsValidate.RuntimeAliasViolation: ...

        @property
        def future_violations(self) -> FlextInfraProtocolsValidate.FutureAnnotationsViolation: ...

        @property
        def manual_typing_violations(self) -> FlextInfraProtocolsValidate.ManualTypingAliasViolation: ...

        @property
        def compatibility_alias_violations(self) -> FlextInfraProtocolsValidate.CompatibilityAliasViolation: ...

        @property
        def foreign_canonical_alias_violations(self) -> FlextInfraProtocolsValidate.CompatibilityAliasViolation: ...

        @property
        def class_placement_violations(self) -> FlextInfraProtocolsValidate.ClassPlacementViolation: ...

        @property
        def mro_completeness_violations(self) -> FlextInfraProtocolsValidate.MROCompletenessViolation: ...

        @property
        def bare_except_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def print_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def breakpoint_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def open_encoding_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def dict_annotation_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def typing_dict_attr_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def typing_dict_import_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def hardcoded_version_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def type_ignore_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def noqa_violations(self) -> FlextInfraProtocolsValidate.PatternSmellViolation: ...

        @property
        def inline_import_violations(self) -> FlextInfraProtocolsValidate.InlineImportViolation: ...

        @property
        def silent_failure_violations(self) -> FlextInfraProtocolsValidate.SilentFailureViolation: ...

        @property
        def parse_failures(self) -> FlextInfraProtocolsValidate.ParseFailureViolation: ...
    ...
    class ProjectTypeOverridesConfig(p.BaseModel, Protocol):
        ...
        @property
        def integration(self) -> FlextInfraProtocolsValidate.ProjectTypeOverrideConfig: ...
    ...
    class ToolConfigDocument(p.BaseModel, Protocol):
        ...
        @property
        def project_type_overrides(self) -> FlextInfraProtocolsValidate.ProjectTypeOverridesConfig: ...
    ...
    class ToolingPyrightEnvironment(p.BaseModel, Protocol):
        ...
        @property
        def settings(self) -> t.SequenceOf[FlextInfraProtocolsValidate.ToolingScalarSetting]: ...
    ...
    class ToolingRuntimeContext(p.BaseModel, Protocol):
        ...
        @property
        def pyright_settings(self) -> t.SequenceOf[FlextInfraProtocolsValidate.ToolingScalarSetting]: ...

        @property
        def pyright_execution_environments(self) -> t.SequenceOf[FlextInfraProtocolsValidate.ToolingPyrightEnvironment]: ...
