    ...
    def walk_ast_nodes(
        ...
        while stack:
            ...
            for field_name in getattr(node, "_fields", ()):
                ...
                elif value is not None and FlextInfraUtilitiesRopeAnalysisAstHelpers.is_ast_node(value):
                    stack.append(value)
        return collected

    @staticmethod
    def ast_parent_map(root: p.AttributeProbe) -> MutableMapping[int, t.Infra.RopeAstNode]:
