"""Bootstrap-safe AST source scanner for FLEXT migration candidates."""
...
class FlextInfraUtilitiesFlextScanSource:
    ...
    @classmethod
    def find_facade(
        cls, source: str, spec: FlextInfraModelsFlextScan.FLEXTTargetSpec
    ) -> str:
    ...
    def candidates(
        cls, source: str, spec: FlextInfraModelsFlextScan.FLEXTTargetSpec
    ) -> t.SequenceOf[FlextInfraModelsFlextScan.FLEXTSymbolCandidate]:
        """Return movable top-level symbols for the target family."""
        tree = ast.parse(source)
        candidates: list[FlextInfraModelsFlextScan.FLEXTSymbolCandidate] = []
    ...
    def _candidate_from_node(
        cls, node: ast.stmt, spec: FlextInfraModelsFlextScan.FLEXTTargetSpec
    ) -> FlextInfraModelsFlextScan.FLEXTSymbolCandidate | None:
...
__all__: list[str] = ["FlextInfraUtilitiesFlextScanSource"]
