...
_LAZY_MODULES: dict[str, tuple[str, ...]] = {
    ...
    "._git.semantic_submodule": ("FlextInfraUtilitiesGitSemanticSubmoduleMixin",),
    "._git.semantic_worktree": ("FlextInfraUtilitiesGitSemanticWorktreeMixin",),
    "._git.worktree": ("FlextInfraUtilitiesGitWorktreeMixin",),
    "._git.worktree_checkpoint": ("FlextInfraUtilitiesGitWorktreeCheckpointMixin",),
    "._git.worktree_discovery": ("FlextInfraUtilitiesGitWorktreeDiscoveryMixin",),
