...
def validate_invocation(command: p.Infra.Promoted.Command) -> None:
    """Validate environment parameters before command execution.

    Raises:
        RegistryError: When a required parameter has no value or a supplied
            value is not among the parameter's declared choices.
