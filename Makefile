...
# Structural refactoring has one public ast-grep route. Apply mode preserves
# every resulting edit for fix-forward repair; it never commits or rolls back a
# caller's worktree behind the operator's back.
