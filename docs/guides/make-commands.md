...
The final generation pass proves the fixed point. `APPLY=Y` is the sole mutation flag.
No project, file, pattern, action, phase, fix, or changed-only selector may be attached
to a standard verb.
