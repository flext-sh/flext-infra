...
class TestSafetyWorkspaceValidation:
    def test_validate_workspace_clean_true_for_clean_repo(self, tmp_path: Path) -> None:
        _init_git_repo(tmp_path)

        result = u.Infra.validate_workspace_clean(tmp_path)
