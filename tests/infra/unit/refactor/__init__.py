...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "FAMILY_FILE_MAP": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "FAMILY_FILE_MAP"),
    "FAMILY_SUFFIX_MAP": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "FAMILY_SUFFIX_MAP"),
    "test_all_three_capabilities_in_one_pass": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_all_three_capabilities_in_one_pass"),
    ...
    "test_converts_multiple_aliases": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_converts_multiple_aliases"),
    "test_converts_typealias_to_pep695": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_converts_typealias_to_pep695"),
    "test_detects_attribute_base_class": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_detects_attribute_base_class"),
    "test_detects_basemodel_in_non_model_file": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_detects_basemodel_in_non_model_file"),
    "test_detects_missing_local_composition_base": ("tests.infra.unit.refactor.test_infra_refactor_mro_completeness", "test_detects_missing_local_composition_base"),
    "test_detects_multiple_models": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_detects_multiple_models"),
    "test_detects_only_wrong_alias_in_mixed_import": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_detects_only_wrong_alias_in_mixed_import"),
    "test_detects_same_project_submodule_alias_import": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_detects_same_project_submodule_alias_import"),
    "test_detects_wrong_source_m_import": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_detects_wrong_source_m_import"),
    "test_detects_wrong_source_u_import": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_detects_wrong_source_u_import"),
    ...
    "test_expected_dependency_bases_by_family_preserves_internal_dependency_order": ("tests.infra.unit.refactor.test_infra_refactor_project_classifier", "test_expected_dependency_bases_by_family_preserves_internal_dependency_order"),
    "test_import_alias_detector_skips_facade_and_subclass_files": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_import_alias_detector_skips_facade_and_subclass_files"),
    "test_import_alias_detector_skips_nested_private_and_as_renames": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_import_alias_detector_skips_nested_private_and_as_renames"),
    "test_import_alias_detector_skips_private_and_class_imports": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_import_alias_detector_skips_private_and_class_imports"),
    ...
    "test_injects_t_import_when_needed": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_injects_t_import_when_needed"),
    ...
    "test_namespace_rewriter_keeps_contextual_alias_subset": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_namespace_rewriter_keeps_contextual_alias_subset"),
    "test_namespace_rewriter_only_rewrites_runtime_alias_imports": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_namespace_rewriter_only_rewrites_runtime_alias_imports"),
    "test_namespace_rewriter_skips_facade_and_subclass_files": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_namespace_rewriter_skips_facade_and_subclass_files"),
    "test_namespace_rewriter_skips_nested_private_as_rename_and_duplicates": ("tests.infra.unit.refactor.test_infra_refactor_namespace_aliases", "test_namespace_rewriter_skips_nested_private_as_rename_and_duplicates"),
    "test_no_duplicate_t_import_when_t_from_project_package": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_no_duplicate_t_import_when_t_from_project_package"),
    "test_non_pydantic_class_not_flagged": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_non_pydantic_class_not_flagged"),
    "test_noop_clean_module": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_noop_clean_module"),
    ...
    "test_preserves_annotated_in_function_params": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_annotated_in_function_params"),
    "test_preserves_non_matching_unions": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_non_matching_unions"),
    "test_preserves_override_in_method": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_override_in_method"),
    "test_preserves_protocol_and_runtime_checkable": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_protocol_and_runtime_checkable"),
    "test_preserves_type_checking_import": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_type_checking_import"),
    "test_preserves_typealias_import_when_class_level_usage_exists": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_typealias_import_when_class_level_usage_exists"),
    "test_preserves_used_imports_when_import_precedes_usage": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_used_imports_when_import_precedes_usage"),
    "test_preserves_used_typing_imports": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_preserves_used_typing_imports"),
    "test_project_without_alias_facade_has_no_violation": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_project_without_alias_facade_has_no_violation"),
    "test_read_project_metadata_preserves_pep621_dependency_order": ("tests.infra.unit.refactor.test_infra_refactor_project_classifier", "test_read_project_metadata_preserves_pep621_dependency_order"),
    "test_read_project_metadata_preserves_poetry_dependency_order": ("tests.infra.unit.refactor.test_infra_refactor_project_classifier", "test_read_project_metadata_preserves_poetry_dependency_order"),
    ...
    "test_removes_all_imports_when_none_used_import_first": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_removes_all_imports_when_none_used_import_first"),
    "test_removes_all_unused_typing_imports": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_removes_all_unused_typing_imports"),
    "test_removes_dead_typealias_import": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_removes_dead_typealias_import"),
    "test_removes_typealias_import_only_when_all_usages_converted": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_removes_typealias_import_only_when_all_usages_converted"),
    "test_removes_unused_preserves_used_when_import_precedes_usage": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_removes_unused_preserves_used_when_import_precedes_usage"),
    "test_replaces_container_union": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_replaces_container_union"),
    "test_replaces_numeric_union": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_replaces_numeric_union"),
    "test_replaces_primitives_union": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_replaces_primitives_union"),
    "test_replaces_scalar_union": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_replaces_scalar_union"),
    "test_rewriter_adds_missing_base_and_formats": ("tests.infra.unit.refactor.test_infra_refactor_mro_completeness", "test_rewriter_adds_missing_base_and_formats"),
    "test_rewriter_namespace_source_is_idempotent_with_ruff": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_rewriter_namespace_source_is_idempotent_with_ruff"),
    "test_rewriter_preserves_non_alias_symbols": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_rewriter_preserves_non_alias_symbols"),
    "test_rewriter_splits_mixed_imports_correctly": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_rewriter_splits_mixed_imports_correctly"),
    ...
    "test_skips_definition_files": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_skips_definition_files"),
    "test_skips_facade_declaration_files": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_facade_declaration_files"),
    "test_skips_import_as_rename": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_import_as_rename"),
    "test_skips_init_file": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_init_file"),
    "test_skips_models_directory": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_skips_models_directory"),
    "test_skips_models_file": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_skips_models_file"),
    "test_skips_non_alias_symbols": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_non_alias_symbols"),
    "test_skips_non_facade_files": ("tests.infra.unit.refactor.test_infra_refactor_mro_completeness", "test_skips_non_facade_files"),
    "test_skips_private_candidate_classes": ("tests.infra.unit.refactor.test_infra_refactor_mro_completeness", "test_skips_private_candidate_classes"),
    "test_skips_private_class": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_skips_private_class"),
    "test_skips_protected_files": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_skips_protected_files"),
    "test_skips_r_alias_universal_exception": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_r_alias_universal_exception"),
    "test_skips_same_project_private_submodule": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_same_project_private_submodule"),
    "test_skips_same_project_submodule_class_import": ("tests.infra.unit.refactor.test_infra_refactor_namespace_source", "test_skips_same_project_submodule_class_import"),
    "test_skips_settings_file": ("tests.infra.unit.refactor.test_infra_refactor_class_placement", "test_skips_settings_file"),
    "test_skips_union_with_none": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_skips_union_with_none"),
    "test_skips_when_candidate_is_already_in_facade_bases": ("tests.infra.unit.refactor.test_infra_refactor_mro_completeness", "test_skips_when_candidate_is_already_in_facade_bases"),
    ...
    "test_typealias_conversion_preserves_used_typing_siblings": ("tests.infra.unit.refactor.test_infra_refactor_typing_unifier", "test_typealias_conversion_preserves_used_typing_siblings"),
