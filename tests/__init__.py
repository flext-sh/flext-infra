...
if TYPE_CHECKING:
    ...
    from .constants_tests import TestsFlextInfraConstants
    from .infra import unit as unit
    from .infra.constants_tests import FlextInfraTestConstants, c
    ...
    from .infra.helpers import FlextInfraTestHelpers, h
    from .infra.models_tests import FlextInfraTestModels, m
    from .infra.protocols_tests import FlextInfraTestProtocols, p
    ...
    from .infra.typings_tests import FlextInfraTestTypes, t
    ...
    from .infra.unit.deps.test_detection_wrappers import (
    ...
    from .infra.unit.github.linter_tests import TestFlextInfraWorkflowLinter
    ...
    from .infra.unit.github.pr_cli_tests import (
        TestMainFunction,
        TestParseArgs,
        TestSelectorFunction,
    )
    from .infra.unit.github.pr_init_tests import TestGithubInit
    from .infra.unit.github.pr_operations_tests import (
        TestChecks,
        TestClose,
        TestMerge,
        TestTriggerRelease,
    ...
    from .infra.unit.github.pr_tests import (
        TestCreate,
        TestFlextInfraPrManager,
        TestStatus,
    )
    from .infra.unit.github.pr_workspace_orchestrate_tests import (
        TestOrchestrate,
        TestStaticMethods,
    )
    from .infra.unit.github.pr_workspace_tests import (
        TestCheckpoint,
        TestFlextInfraPrWorkspaceManager,
        TestRunPr,
    )
    from .infra.unit.github.workflows_tests import (
        TestFlextInfraWorkflowSyncer,
        TestRenderTemplate,
        TestSyncOperation,
        TestSyncProject,
    )
    from .infra.unit.github.workflows_workspace_tests import (
        TestSyncWorkspace,
        TestWriteReport,
    )
    ...
    from .infra.utilities_tests import FlextInfraTestUtilities, u
    ...
    from .models_tests import TestsFlextInfraModels
    from .protocols_tests import TestsFlextInfraProtocols
    from .typings_tests import TestsFlextInfraTypes
    from .utilities_tests import TestsFlextInfraUtilities
...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "FlextInfraTestConstants": (
        "tests.infra.constants_tests",
        "FlextInfraTestConstants",
    ),
    "FlextInfraTestHelpers": ("tests.infra.helpers", "FlextInfraTestHelpers"),
    "FlextInfraTestModels": ("tests.infra.models_tests", "FlextInfraTestModels"),
    "FlextInfraTestProtocols": (
        "tests.infra.protocols_tests",
        "FlextInfraTestProtocols",
    ),
    "FlextInfraTestTypes": ("tests.infra.typings_tests", "FlextInfraTestTypes"),
    "FlextInfraTestUtilities": (
        "tests.infra.utilities_tests",
        "FlextInfraTestUtilities",
    ),
    ...
    "TestFlextInfraPrManager": (
        "tests.infra.unit.github.pr_tests",
        "TestFlextInfraPrManager",
    ),
    "TestFlextInfraPrWorkspaceManager": (
        "tests.infra.unit.github.pr_workspace_tests",
        "TestFlextInfraPrWorkspaceManager",
    ),
    ...
    "TestFlextInfraWorkflowLinter": (
        "tests.infra.unit.github.linter_tests",
        "TestFlextInfraWorkflowLinter",
    ),
    "TestFlextInfraWorkflowSyncer": (
        "tests.infra.unit.github.workflows_tests",
        "TestFlextInfraWorkflowSyncer",
    ),
    ...
    "TestOrchestrate": (
        "tests.infra.unit.github.pr_workspace_orchestrate_tests",
        "TestOrchestrate",
    ),
    "TestOrchestratorBasic": (
    ...
    "TestSelectorFunction": (
        "tests.infra.unit.github.pr_cli_tests",
        "TestSelectorFunction",
    ),
    "TestShouldBubbleUp": (
        "tests.infra.unit.codegen.lazy_init_transforms_tests",
    ...
    "TestSyncWorkspace": (
        "tests.infra.unit.github.workflows_workspace_tests",
        "TestSyncWorkspace",
    ),
    "TestSynthesizedRepoMap": (
        "tests.infra.unit.deps.test_internal_sync_resolve",
    ...
    "TestTriggerRelease": (
        "tests.infra.unit.github.pr_operations_tests",
        "TestTriggerRelease",
    ),
    "TestUpdateChangelog": (
        "tests.infra.unit.release.orchestrator_helpers_tests",
    ...
    "TestsFlextInfraConstants": ("tests.constants_tests", "TestsFlextInfraConstants"),
    "TestsFlextInfraModels": ("tests.models_tests", "TestsFlextInfraModels"),
    "TestsFlextInfraProtocols": ("tests.protocols_tests", "TestsFlextInfraProtocols"),
    "TestsFlextInfraTypes": ("tests.typings_tests", "TestsFlextInfraTypes"),
    "TestsFlextInfraUtilities": ("tests.utilities_tests", "TestsFlextInfraUtilities"),
    ...
    "c": ("tests.infra.constants_tests", "c"),
    ...
    "p": ("tests.infra.protocols_tests", "p"),
    ...
    "u": ("tests.infra.utilities_tests", "u"),
