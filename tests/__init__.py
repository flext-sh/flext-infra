...
_LAZY_IMPORTS: dict[str, tuple[str, str]] = {
    ...
    "ProjectResult": ("tests.infra.unit.check.extended_run_projects_tests", "ProjectResult"),
    ...
    "TestStringList": ("tests.infra.unit.validate.skill_validator_tests", "TestStringList"),
