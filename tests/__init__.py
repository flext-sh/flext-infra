...
# NOTE(mro-p68a.9.4, agent codex): restored the generated test facade from the
# accidentally tracked ``tests/__init__ .py`` path so pytest imports c/t/u.
