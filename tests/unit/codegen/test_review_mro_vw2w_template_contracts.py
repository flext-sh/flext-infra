...
class TestsReviewTemplateContracts:
    ...
    def test_makefile_deps_modernize_uses_selected_projects(self) -> None:
        ...
        # Regression: PROJECTS-only ignored PROJECT= selector.
