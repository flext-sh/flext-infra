...
from flext_infra.gates import FlextInfraBudgetGate
...
class TestsCodegenFilePlanStateDiffers:
    ...
    def test_mode_delta_differs_even_with_equal_content(self, tmp_path: Path) -> None:
        ...
        tm.that(drifted, eq=True)


class TestsFlextInfraBudgetGateSpot:
    """Budget gate stays reachable through the generated facade export."""

    def test_gate_exported_through_lazy_facade(self) -> None:
        tm.that(FlextInfraBudgetGate.gate_id, eq="budget")
