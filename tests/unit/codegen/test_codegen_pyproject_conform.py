...
"""
        ...
        for expected in (
            "flext-core[async] @ git+https://github.com/flext-sh/flext-core.git@0.20.0-dev; python_version >= '3.13'",
            "flext-infra @ git+https://github.com/flext-sh/flext-infra.git@0.20.0-dev",
            "flext-tests @ git+https://github.com/flext-sh/flext-tests.git@0.20.0-dev",
            "flext-web @ git+https://github.com/flext-sh/flext-web.git@0.20.0-dev",
            "[tool.uv.sources.beartype]",
            'tag = "v0.22.9"',
        ):
