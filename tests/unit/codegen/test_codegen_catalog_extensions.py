...
class TestsCodegenCatalogExtensions:
    ...
    def test_setup_provisions_only_and_gen_owns_conformance(self) -> None:
        ...
        # The Mise transaction replaced the HTTP "latest release" probe with a
        # launcher generated by the tracked, checksum-verified `bin/mise`, so
        # the bootstrap reaches no network at all.
        tm.that(bootstrap, has="generate install-script")
