...
_LAZY_IMPORTS: Mapping[str, Sequence[str]] = {
    ...
    "test_make_boot_works_without_existing_venv_in_workspace_mode": ["tests.unit.basemk.test_make_contract", "test_make_boot_works_without_existing_venv_in_workspace_mode"],
    "test_make_check_file_scope_rejects_unsupported_gates": ["tests.unit.basemk.test_make_contract", "test_make_check_file_scope_rejects_unsupported_gates"],
    "test_make_check_file_scope_runs_mypy": ["tests.unit.basemk.test_make_contract", "test_make_check_file_scope_runs_mypy"],
    "test_make_help_lists_supported_options": ["tests.unit.basemk.test_make_contract", "test_make_help_lists_supported_options"],
    "test_render_all_declares_and_documents_runtime_options": ["tests.unit.basemk.test_engine", "test_render_all_declares_and_documents_runtime_options"],
    "test_render_all_exposes_canonical_public_targets": ["tests.unit.basemk.test_engine", "test_render_all_exposes_canonical_public_targets"],
