"""Tests for real workspace rewrites after FLEXT migration."""
...
class TestsFlextInfraRefactorInfraRefactorFlextImportRewriter:
    """Behavior contract for test_infra_refactor_flext_import_rewriter."""

    def test_migrate_workspace_applies_consumer_rewrites(self, tmp_path: Path) -> None:
        workspace_root, constants_path, consumer_path = (
            u.Tests.build_flext_import_workspace(tmp_path)
        )

        migrations, rewrites, errors = u.Tests.migrate_workspace_flext_imports(
