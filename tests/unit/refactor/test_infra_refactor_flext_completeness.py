"""Tests for refactor FLEXT-completeness detection."""
...
class TestsFlextInfraRefactorInfraRefactorFlextCompleteness:
    """Behavior contract for test_infra_refactor_flext_completeness."""
    ...
    def test_detects_missing_local_composition_base(self, tmp_path: Path) -> None:
        ...
        violations = FlextInfraFLEXTCompletenessDetector.detect_file(
