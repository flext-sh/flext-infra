"""Tests for refactor FLEXT-shape detection."""
...
def _detect(
    ...
    return FlextInfraFLEXTShapeDetector.detect_file(
        m.Infra.DetectorContext(file_path=file_path, rope_project=rope_project)
    )


class TestsFlextInfraRefactorInfraRefactorFlextShape:
    """Behavior contract for the rope FLEXT-shape detector."""
    ...
    def test_parse_failure_is_reported(
        ...
        tm.that(parse_failures[0].stage, eq="flext_shape")
