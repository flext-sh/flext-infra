...
__all__: tuple[str, ...] = (
    "ExtraPathsTestSupport", "TestsFlextInfraDepsDetectionClassify", "TestsFlextInfraDepsDetectionDeptry", "TestsFlextInfraDepsDetectionDiscover",
    "TestsFlextInfraDepsDetectionModels", "TestsFlextInfraDepsDetectionTypings", "TestsFlextInfraDepsDetectionTypingsFlow", "TestsFlextInfraDepsDetectionUncovered",
    "TestsFlextInfraDepsDetectorDetect", "TestsFlextInfraDepsDetectorDetectFailures", "TestsFlextInfraDepsDetectorInit", "TestsFlextInfraDepsDetectorMain",
    "TestsFlextInfraDepsDetectorModels", "TestsFlextInfraDepsDetectorReport", "TestsFlextInfraDepsDetectorReportFlags", "TestsFlextInfraDepsExtraPathsSync",
    "TestsFlextInfraDepsInit", "TestsFlextInfraDepsMainDispatch", "TestsFlextInfraDepsModernizerComments", "TestsFlextInfraDepsModernizerConsolidate",
    "TestsFlextInfraDepsModernizerHelpers", "TestsFlextInfraDepsModernizerMain", "TestsFlextInfraDepsModernizerMainExtra", "TestsFlextInfraDepsModernizerPackaging",
    ...
    "TestsFlextInfraExtraPathsManager", "TestsFlextInfraExtraPathsSearchPaths", "TestsFlextInfraModernizerPyrefly", "TestsFlextInfraProjectGitignorePatterns",
    "TestsFlextInfraProjectMiseTools", "TestsFlextInfraPytestFailClosedConfig", "TestsFlextInfraPytestTimeoutConfig", "c",
    "d", "e", "h", "m",
    "p", "r", "s", "t",
    "td", "tf", "tk", "tm",
    "tv", "u", "x",
