...
"""Lazy-import manifest — single source of truth for tests.unit.__init__.py.
...
LAZY_MODULES: dict[str, tuple[str, ...]] = {
    ...
    ".basemk.test_generator_edge_cases": ("TestsFlextInfraBasemkGeneratorEdgeCases",),
    ...
    ".check.extended_error_reporting_tests": ("TestGateErrorReportingPublicBehavior",),
    ...
    ".codegen.lazy_init_generation_tests": ("TestsFlextInfraCodegenGeneration",),
    ...
    ".codegen.lazy_init_registry_wrapper_tests": ("TestsFlextInfraLazyInitCleanup",),
    ".codegen.lazy_init_service_tests": ("TestsFlextInfraCodegenLazyInitService",),
    ...
    ".deps.test_detection_typings_flow": ("TestsFlextInfraDepsDetectionTypingsFlow",),
    ...
    ".deps.test_extra_paths_search_paths": ("TestsFlextInfraExtraPathsSearchPaths",),
    ...
    ".deps.test_internal_sync_discovery": ("TestsFlextInfraDepsInternalSyncDiscovery",),
    ...
    ".deps.test_internal_sync_sync_edge": ("TestsFlextInfraDepsInternalSyncSyncEdge",),
    ...
    ".deps.test_internal_sync_workspace": ("TestsFlextInfraDepsInternalSyncWorkspace",),
    ...
    ".deps.test_modernizer_consolidate": ("TestsFlextInfraDepsModernizerConsolidate",),
    ...
    ".detectors.test_loose_object_detector": ("TestsFlextInfraLooseObjectDetector",),
    ".detectors.test_loose_test_function_detector": (
        "TestsFlextInfraLooseTestFunctionDetector",
    ),
    ".detectors.test_pattern_smell_detector": ("TestsFlextInfraPatternSmellDetector",),
    ...
    ".io.test_infra_terminal_detection": ("TestsFlextInfraIoInfraTerminalDetection",),
