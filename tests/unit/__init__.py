    ...
    MappingProxyType(
        build_lazy_import_map(
            MappingProxyType({
                ...
                ".basemk": ("basemk",),
                ".basemk.test_bootstrap_refname_safety": (
                    "TestsBootstrapRefnameSafety",
                ),
                ...
                ".check.extended_project_runners_tests": (
                    "TestsExtendedProjectRunners",
                ),
                ...
                ".check.extended_run_projects_tests": (
                    "TestRunProjectsPublicBehavior",
                ),
                ...
                ".codegen.lazy_init_process_tests": (
                    "TestsFlextInfraLazyInitProcessing",
                ),
                ...
                ".codegen.test_codegen_make_environment": (
                    "TestsCodegenMakeEnvironment",
                ),
                ...
                ".deps.test_modernizer_pyright": (
                    "TestsFlextInfraDepsModernizerPyright",
                ),
                ".deps.test_modernizer_pytest": (
                    "TestsFlextInfraDepsModernizerPytest",
                ),
                ".deps.test_modernizer_tooling": (
                    "TestsFlextInfraDepsModernizerTooling",
                ),
                ...
                ".deps.test_pytest_timeout_config": (
                    "TestsFlextInfraPytestTimeoutConfig",
                ),
                ".detectors": ("detectors",),
                ...
                ".release.orchestrator_helpers_tests": (
                    "TestsFlextInfraReleaseHelpers",
                ),
                ".release.orchestrator_publish_tests": (
                    "TestsFlextInfraReleasePublish",
                ),
                ".release.orchestrator_tests": ("TestsFlextInfraReleaseOrchestration",),
                ".release.policy_fixture_root_tests": (
                    "TestsReleasePolicyFixtureRoot",
                ),
                ...
                ".test_infra_root_export_contract": (
                    "TestsFlextInfraRootExportContract",
                ),
