...
Read the [review procedure](references/procedure.md). Review is read-only unless the
user separately authorizes implementation. Missing review targets, owners, or required
context stop before a verdict; never invent findings, approve by default, or substitute
another range.
